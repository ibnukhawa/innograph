...
class ProjectPurchaseOrder(models.Model):
    ...
    name = fields.Char(string='Name & Specification of Item', required=True)
...
class PurchaseOrderLine(models.Model):
    ...
    project_ids = fields.Many2many('project.purchase.order','project_purchase_order_purchase_order_lines_rel', 'purchase_order_id', 'project_id', string='Project')
    
class PurchaseReport(models.Model):
    _inherit = "purchase.report"
    
    project_id = fields.Many2one('project.purchase.order', string='Project Code', readonly=True)
        ...
        self._cr.execute("""
            create or replace view purchase_report as (
                ...
                from purchase_order_line l
                    ...
                    left join project_purchase_order_purchase_order_lines_rel ppo on (ppo.project_id=l.id)
                group by
                    s.company_id,
                    s.create_uid,
                    s.partner_id,
